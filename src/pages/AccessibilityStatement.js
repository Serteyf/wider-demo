...
export default function AccessibilityStatement() {
  ...
  return (
    <Container>
      <h1
        className="titulo-xxl color-white pt-180 mb-50"
      ...
      <ul className="p-nav color-white mb-50">
        ...
        <li dangerouslySetInnerHTML={{ __html: t("non_accessible_content.burden") }}></li>
        <li dangerouslySetInnerHTML={{ __html: t("non_accessible_content.legislation") }}></li>
      </ul>

      <h2 className="h2-privacy-policy">{t("statement_title")}</h2>
      <p
        className="p-nav color-white mb-50"
        dangerouslySetInnerHTML={{ __html: t("statement_p") }}
      ></p>
      ...
      <p className="p-nav color-white mb-50">
        ...
        <a href="mailto:accesibilidad@wider.global" className="color-white">
          {" "}
          accesibilidad@wider.global
        </a>
        .
      </p>
      ...
      <ul className="p-nav color-white">
        <li>
          ...
          <a href="http://www.defensordelpueblo.es" className="color-white">
            {" "}
