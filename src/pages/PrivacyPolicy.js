...
export default function PrivacyPolicy() {
  ...
  return (
    <Container>
      <h1
        className="titulo-xxl color-white pt-180 "
      ...
      <ul className="definition-list mb-50">
        ...
        <li
          className="p-nav color-white"
          dangerouslySetInnerHTML={{ __html: t("definitions.website") }}
        ></li>
      ...
      <p className="p-nav color-white">{t("data_use.intro")}</p>
